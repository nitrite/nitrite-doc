...
Document ID is a unique identifier of a document. It is auto-generated by Nitrite database during insertion. It is a `NitriteId` and is stored as a `String` in the document.
...
During insertion if a unique `String` value representing a 64-bit integer is supplied in the '_id' field of the document, then the value of the '_id' field will be used to generate the `NitriteId`. Otherwise, a new `NitriteId` will be generated and will be used as the '_id' field of the document.
